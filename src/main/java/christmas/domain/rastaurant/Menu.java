...
public class Menu {
    ...
    private static void createDessertItem() {
        DESSERT.add(new MenuItem("초코케이크", 15000));
        DESSERT.add(new MenuItem("아이스크림", 5000));
    }

    private static void createBeverageItem() {
